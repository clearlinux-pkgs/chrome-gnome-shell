...
Source0  : https://download.gnome.org/sources/chrome-gnome-shell/10/chrome-gnome-shell-10.tar.xz
...
%prep
%setup -q -n chrome-gnome-shell-10
...
export LANG=C
export SOURCE_DATE_EPOCH=1517780139
mkdir clr-build
pushd clr-build
